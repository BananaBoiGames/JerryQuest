/// @description  draw_sprite_tiled_area_ext(sprite,subimg,x,y,x1,y2,x2,y2,color,alpha)
function draw_sprite_tiled_area_ext(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9) {
	//
